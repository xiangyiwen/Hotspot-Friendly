//
// Created by root on 2022/9/19.
//

#ifndef DBX1000_BLOOM_FILTER_H
#define DBX1000_BLOOM_FILTER_H
...
public:
    ...
    inline bloom_filter& operator ^= (const bloom_filter& f){
     ...
     /**
      * concurrent_vector has no data() function
      * @return
      */
...
//    std::vector<unsigned char> bit_table_;
    tbb::concurrent_vector<unsigned char> bit_table_;
...
public:
    ...
    /**
     * Unused Function with compile error, so I ignore it
     */
